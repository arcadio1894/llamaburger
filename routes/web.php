...
Route::get('/imprimir/comanda-mesa/{id}', [PrintController::class, 'generarComandaMesa']);
...
Route::get('/kitchen/comandas/get-data-comanda', [ComandaController::class, 'getDataComanda']);
